...
import com.matalex.hotels.databinding.ItemRoomBinding
...
class RoomsListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = ItemRoomBinding.inflate(inflater, container, false)

        binding.apply {
            val currentRoomData = infoAboutRoom()
...
private fun infoAboutRoom(): RoomData {
    ...
    return RoomData(
        rooms = listOf(
            Room(
                ...
                peculiarities = listOf("Включен только завтрак", "Кондиционер"),
                price = 186600, pricePer = "За 7 ночей с перелетом"
            ),

            Room(
                id = 2, name = "Люкс номер с видом на море",
                imageUrls = listOf(
                ...
                peculiarities = listOf("Все включено", "Кондиционер", "Собственный бассейн"),
                price = 289400,
